...
[ScriptedImporter(1, "xramap")]
public class XragmapImporter : ScriptedImporter
{
...
internal class MetaXRAcousticMap : MonoBehaviour
{
    ...
    {
        return $"{MetaXRAcousticSettings.AcousticFileRootDir}/{scene.name}/AcousticData/{scene.name}.{FILE_EXTENSION}";
    ...
    private async UniTaskVoid LoadMapAddressable(string address)
    {
