...
public class MetaXRAcousticNativeInterface
{
    ...
    public interface INativeInterface
    {
        ...
        /***********************************************************************************/
        // Diffraction API
        /// \brief Set the diffraction order to trade off between diffraction quality and resource usage
        ///
        /// \param[in] value The number of diffraction events that can occur along a single sound propagation path
        /// \return Returns an ovrResult indicating success or failure
